...
public class EntityForbiddenArrow extends Entity implements IProjectile
{
    ...
    public EntityForbiddenArrow(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public EntityForbiddenArrow(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityForbiddenArrow(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityForbiddenArrow(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public void onUpdate()
    {
        ...
        if (this.inGround)
        {
            ...
            if (block == this.field_145790_g && j == this.inData)
            {
                ...
                {
                    this.setDead();
                    EntitySilverfish entitysilver = new EntitySilverfish(this.worldObj);
                    this.worldObj.spawnEntityInWorld(entitysilver);
    ...
    public void onCollideWithPlayer(EntityPlayer p_70100_1_)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (flag)
            {
                ...
                EntitySilverfish entitysilver = new EntitySilverfish(this.worldObj);
                entitysilver.setLocationAndAngles(this.posX, this.posY, this.posZ, this.rotationYaw, 0.0F);
                this.worldObj.spawnEntityInWorld(entitysilver);
                this.setDead();
            }
        }
    ...
    {	
       ...
       int j = MathHelper.floor_double(this.posZ - 1.0D + this.rand.nextDouble() * 2.0D);
        ...
        {
            this.worldObj.setBlock(k, i, j,Blocks.lava);
        }
