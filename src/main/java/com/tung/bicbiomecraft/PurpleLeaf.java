...
public class PurpleLeaf extends Block{
	private boolean field_150187_a;
	int[] field_150128_a;
	protected PurpleLeaf(Material p_i45394_1_) {
		super(p_i45394_1_);
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
    	...
    	if (par5Random.nextInt(4) == 0) {
    		 par1World.spawnParticle("portal", par2 + par5Random.nextFloat(), par3 + 1.2F, par4 + par5Random.nextFloat(), 0.0D, 0.0D, 0.0D);
    	    }
    	if (par5Random.nextInt(4) == 0) {
   		 par1World.spawnParticle("portal", par2 + par5Random.nextFloat(), par3 + 1.2F, par4 + par5Random.nextFloat(), 0.0D, 0.0D, 0.0D);
   	    }
