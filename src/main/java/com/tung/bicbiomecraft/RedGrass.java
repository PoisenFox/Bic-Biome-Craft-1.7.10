...
public class RedGrass extends Block{

	public RedGrass(Material p_i45394_1_) {
		super(p_i45394_1_);
	...
	public IIcon field94392_b;//bottom
	 @SideOnly(Side.CLIENT)
	    ...
	    {
	        this.blockIcon = par1registerIcon.registerIcon("bicbiome:redgrass_side");
	        this.field94393_a = par1registerIcon.registerIcon("bicbiome:redgrass_top");
	        this.field94392_b = par1registerIcon.registerIcon("bicbiome:redgrass_side_overlay");
	    }
