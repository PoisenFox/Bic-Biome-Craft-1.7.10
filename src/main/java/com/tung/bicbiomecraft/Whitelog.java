...
public class Whitelog extends BlockLog{
	public Whitelog(Material p_i45394_1_) {
		super();
	...
	public IIcon field94392_b;//bottom
	 @SideOnly(Side.CLIENT)
	    ...
	    {
	        this.blockIcon = par1registerIcon.registerIcon("bicbiome:whitelog_side");
	        this.field94393_a = par1registerIcon.registerIcon("bicbiome:whitelog_top");
	        this.field94392_b = par1registerIcon.registerIcon("bicbiome:whitelog_top");
	    }
