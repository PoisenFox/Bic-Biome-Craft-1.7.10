...
public class OrangeGrass extends Block{
	...
	public OrangeGrass(Material p_i45394_1_) {
		super(p_i45394_1_);
	...
	public IIcon field94392_b;//bottom
	 @SideOnly(Side.CLIENT)
	    ...
	    {
	        this.blockIcon = par1registerIcon.registerIcon("bicbiome:orangegrass_side");
	        this.field94393_a = par1registerIcon.registerIcon("bicbiome:orangegrass_top");
	        this.field94392_b = par1registerIcon.registerIcon("bicbiome:orangegrass_side_overlay");
	    }
