...
public class WorldGenTungTree extends WorldGenAbstractTree
{
    ...
    public WorldGenTungTree(Block wood,Block leaves,int metawood,int metaleaves )
    {
        this( wood, leaves,metawood,metaleaves,false , 0, 0 , false);
    }

    public WorldGenTungTree(Block wood,Block leaves,int metawood,int metaleaves,boolean doBlockNotify,int minTreeHeight,int randomTreeHeight,boolean vinesGrow)
    {
        super(doBlockNotify);
        this.wood = wood;
        this.leaves = leaves;
...
//TODO 
                ...
                if (isSoil && p_76484_4_ < 256 - l - 1)
                {
                        ...
                        for (i2 = p_76484_3_ - l1; i2 <= p_76484_3_ + l1; ++i2)
                        {
                            ...
                            for (int k2 = p_76484_5_ - l1; k2 <= p_76484_5_ + l1; ++k2)
                            {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || p_76484_2_.nextInt(2) != 0 && i3 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndNotifyAdequately(world, i2, k1, k2, Bicbiome.tungleaf, this.metaLeaves);
                                    }
                                }
                            }
                        }
                    ...
                    for (k1 = 0; k1 < l; ++k1)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(world, p_76484_3_, p_76484_4_ + k1, p_76484_5_, Bicbiome.tunglog, this.metaWood);
