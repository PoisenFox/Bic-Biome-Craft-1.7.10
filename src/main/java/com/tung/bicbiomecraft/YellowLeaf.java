...
public class YellowLeaf extends Block{
	int[] field_150128_a;
	public YellowLeaf(Material p_i45394_1_) {
		super(p_i45394_1_);
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
    	...
    	if (par5Random.nextInt(4) == 0) {
    	      par1World.spawnParticle("reddust", par2 + par5Random.nextFloat(), par3 + 1.2F, par4 + par5Random.nextFloat(), 0.0D, 0.0D, 0.0D);
    	    }
    	    if (par5Random.nextInt(4) == 0) {
    	      par1World.spawnParticle("largesmoke", par2 + par5Random.nextFloat(), par3 + 1.2F, par4 + par5Random.nextFloat(), 0.0D, 0.0D, 0.0D);
    	    }
    }
