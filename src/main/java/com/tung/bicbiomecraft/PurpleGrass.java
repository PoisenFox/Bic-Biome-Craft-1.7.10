...
public class PurpleGrass extends Block{

	public PurpleGrass(Material p_i45394_1_) {
		super(p_i45394_1_);
	...
	public IIcon field94392_b;//bottom
	 @SideOnly(Side.CLIENT)
	    ...
	    {
	        this.blockIcon = par1registerIcon.registerIcon("bicbiome:purplegrass_side");
	        this.field94393_a = par1registerIcon.registerIcon("bicbiome:purplegrass_top");
	        this.field94392_b = par1registerIcon.registerIcon("bicbiome:purplegrass_side_overlay");
	    }
