...
public class BiomeGenTNetherJungle extends BiomeGenBase{

	public BiomeGenTNetherJungle(int id){
		super(id);
 ...
 super.decorate(world, random, chunk_X, chunk_Z);
        ...
        WorldGenFlowers redcloudgen = new WorldGenFlowers(Bicbiome.cloudred);
        ...
        for (int j = 0; doGen && j < 2; ++j)
        {
            ...
            //	firegen.func_150550_a(blockflower, BlockFlower.func_149856_f(s));
            redcloudgen.generate(world, random, k, i1, l);
