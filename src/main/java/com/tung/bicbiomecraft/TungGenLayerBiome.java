...
public class TungGenLayerBiome extends GenLayer
{
    ...
    public TungGenLayerBiome(long p_i2122_1_, GenLayer p_i2122_3_, WorldType p_i2122_4_)
    {
        super(p_i2122_1_);
	...
	public static BiomeGenBase BiomeGenTGlassM;
            */
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.biometung, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTWhiteJungle, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTNether, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTGlass, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTWhite, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTYellow, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenColdJungle, 50));
        	
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTungM, 20));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTDesert, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTBluegrass, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTOrangegrass, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTJungle, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTSland, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTPurple, 50));
        	//desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTPurpleJungle, 50));
        	warmBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTBlueJungle, 30));
        	warmBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTGlassM, 50));
            
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTMeadow, 20));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTRedJungle, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTAllTrees, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTNetherJungle, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTHills, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTRedForest, 30));
        }
        else
        {/*
            ...
            desertBiomes.add(new BiomeEntry(BiomeGenBase.plains, 10));*/
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.biometung, 50));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTWhiteJungle, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTNether, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTGlass, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTWhite, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTYellow, 00));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTWhite, 30));
        	
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTungM, 20));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTDesert, 10));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTBluegrass, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTOrangegrass, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTJungle, 30));
        	desertBiomes.add(new BiomeEntry(BiomeRegistry.BiomeGenTSland, 30));
