...
public class BiomeGenTYellow extends BiomeGenBase{

	public BiomeGenTYellow(int id){
		super(id);
		...
		this.topBlock = Bicbiome.yellowgrass;
	...
	public void decorate(World world, Random random, int chunk_X, int chunk_Z)
    {
    	...
    	if (s.startsWith("BiomeGenTYellow"))
    	{
            for (int i = 0; i < 250; i++){
                    ...
                    new WorldGenTYellowTree(Bicbiome.yellowlog,Bicbiome.yellowleaf,0,0,false,4,6,false).generate(world, random, Xcoord1, Ycoord1, Zcoord1);
